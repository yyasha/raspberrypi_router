...
apt update && apt install -y iptables ipset libpcre3 libpcre3-dev zlib1g zlib1g-dev build-essential make libssl-dev ipset libpcre++-dev libcurl4 curl git
